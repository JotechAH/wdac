if SERVER then
    ...
    if !file.Exists( "wdac/hookwhitelist.txt", "DATA" ) then print("WatchDog Hook Whitelist does not exist. Creating!\nTo whitelist hooks, Just place your whitelisted hooks in 'data/wdac/hookwhitelist.txt'") file.Write( "wdac/hookwhitelist.txt", "" ) end
