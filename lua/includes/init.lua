...
if ( SERVER ) then
    ...
    AddCSLuaFile("watchdog/vehicle.lua")
...
if SERVER then
    ...
    include( "wdac/metainf.lua" )

	print (" ")
	print ("=================================================")
	print ("|~ ~ ~ ~ ~  WatchDog Anti-Cheat"..WDAC.Version.."  ~ ~ ~ ~ ~|")
	print ("|~ ~ ~  Tracking down cheaters since 2017  ~ ~ ~|")
	print ("=================================================")
	print (" ")
    print("Initializing WatchDog Anti-Cheat...\n")

	include( "wdac/list.lua" )

    include( "wdac/suspend/module.lua" )
	include( "wdac/suspend/pardon.lua" )
